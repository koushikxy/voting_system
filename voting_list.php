					...
					<div class="card bg-warning">
						...
						<div class="card-body">
							...
							<div class="form-group">
								<b><label class="control-label">Title</label></b>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<button class="btn btn-sm btn-default" type="button"
										onclick="$('#manage-voting').get(0).reset()"> Cancel</button>
								</div>
							</div>
						</div>
					</div>
							...
							<tbody>
								...
								while ($row = $vote->fetch_assoc()):
									...
									<tr>
										...
										<td class=""><a href="index.php?page=manage_voting&id=<?php echo $row['id'] ?>">
												<?php echo $row['title'] ?>
											</a></td>
										<td class="">
										...
										<?php elseif ($row['is_default'] == 0): ?>
											<td class="text-center">
												<div class="badge badge-info update_default" data-id="<?php echo $row['id'] ?>">
													No</div>
											</td>
										<?php endif; ?>
										<td class="text-center">
											<button class="btn btn-sm btn-primary edit_voting" type="button"
												data-id="<?php echo $row['id'] ?>">Edit</button>
											<button class="btn btn-sm btn-danger delete_voting" type="button"
